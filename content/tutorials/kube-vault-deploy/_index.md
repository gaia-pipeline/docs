...
* (Optional) Golang 1.10.3 or later (to run the tests locally).
<br /><br />
...
That's it for now. Continue with the next chapter: [{{%icon circle-arrow-right%}}1 - Setup]({{%relref "tutorials/kube-vault-deploy/setup.md"%}})
<br /><br />
...
Continue with the next chapter: [{{%icon circle-arrow-right%}}1 - Setup]({{%relref "tutorials/kube-vault-deploy/setup.md"%}})
